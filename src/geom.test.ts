...
describe('Matrix4', () => {
	...
	it('calculates the inverse matrix', () => {
		const mat = new Matrix4([
			0.7071067690849304, 0, -0.7071067690849304, -3.535533905029297,
			0, 1, 0, 0,
			0.7071067690849304, 0, 0.7071067690849304, 3.535533905029297,
			0, 0, 0, 1
		]);

		const inv = mat.inverse().toArray();
		expect(inv[0]).toBeCloseTo(0.7071);
		expect(inv[1]).toBeCloseTo(0.0);
		expect(inv[2]).toBeCloseTo(0.7071);
		expect(inv[3]).toBeCloseTo(0.0);
		expect(inv[4]).toBeCloseTo(0.0);
		expect(inv[5]).toBeCloseTo(1.0);
		expect(inv[6]).toBeCloseTo(0.0);
		expect(inv[7]).toBeCloseTo(0.0);
		expect(inv[8]).toBeCloseTo(-0.7071);
		expect(inv[9]).toBeCloseTo(0.0);
		expect(inv[10]).toBeCloseTo(0.7071);
		expect(inv[11]).toBeCloseTo(-5.0);
		expect(inv[12]).toBeCloseTo(0.0);
		expect(inv[13]).toBeCloseTo(0.0);
		expect(inv[14]).toBeCloseTo(0.0);
		expect(inv[15]).toBeCloseTo(1.0);
	});
